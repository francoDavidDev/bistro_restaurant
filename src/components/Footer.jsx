...
const Footer = () => {
  ...
  return (
    <footer className=" relative top-96 z-20 bg-dark lg:bg-transparent lg:min-h-[620px] lg:bg-footer  lg:bg-center lg:bg-repeat pt-20  lg:pt-32 ">
      <div className="container mx-auto  h-full ">
        ...
        className="h-full flex flex-col gap-y-4  ">
          ...
          className="flex flex-col lg:flex-row lg:gap-x-[130px] gap-y-12 lg:gap-y-0 lg:mb-12 ">
            ...
            {/* social */}
            <div className="flex-1 lg:max-h-[280px] mb-12  ">
            <div className="capitalize text-[20px] lg:text-[22px] font-normal text-white font-primary mb-[22px] ">
                {social.title}
              </div>
              <Socials/>
